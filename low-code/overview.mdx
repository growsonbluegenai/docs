...
<CardGroup cols={2}>
  <Card title="Tyler Application Platform" icon="landmark" href="/low-code/tap/overview">
    The only platform with both Prototype and Build Mode.
  </Card>

  <Card title="ServiceNow" icon="settings" href="/low-code/servicenow/overview">
    Seven configuration areas, from tables to Service Portal.
  </Card>

  <Card title="PowerApps" icon="table" href="/low-code/powerapps/overview">
