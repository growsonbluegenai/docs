...
| [**Salesforce**](/low-code/salesforce) | Build | Custom objects and fields, profiles and sharing rules, page layouts and list views, Lightning apps and pages, Lightning Web Components, flows and Apex, reports, platform events |
