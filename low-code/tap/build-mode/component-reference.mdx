---
title: "TAP Builder Tools and Features"
...
<CardGroup cols={2}>
  <Card title="Understand what a TAP project is" icon="info" href="/low-code/tap/overview">
  ...
  <Card title="Meet the agents behind Build Mode" icon="bot" href="/low-code/tap/build-mode/build-agent-guide">
