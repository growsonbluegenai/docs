...
What a ServiceNow project is, which parts of the instance the agent configures, and how to frame a request so it covers the whole feature rather than one piece of it.
