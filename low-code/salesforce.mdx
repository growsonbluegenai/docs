...
Seven areas are in scope. Each is covered in detail in [Component Reference](/low-code/salesforce/component-reference).
...
<CardGroup cols={2}>
  <Card title="See every component in detail" icon="list-tree" href="/low-code/salesforce/component-reference">
