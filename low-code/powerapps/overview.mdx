...
What a PowerApps project covers, which parts of the work the agent applies directly and which it specifies for you to apply, and why PowerApps splits that way when TAP and ServiceNow do not.
