...
<Frame caption="The filter bar. Five dropdowns, each accepting more than one value at a time.">
  ![A close-up of the Tickets filter bar with each control labelled: the result count, the search field, and the Status, Priority, Source, Work Type and Expertise dropdowns, ending with the Create Ticket button.](/images/tickets/what-are-tickets-filter-bar.png)
</Frame>
