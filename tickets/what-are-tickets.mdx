...
<CardGroup cols={2}>
  <Card title="Group and sequence your work" icon="layers" href="/tickets/epics">
    How Epics set the build order, and what re-evaluating them costs you.
  </Card>

  <Card title="Generate Tickets from your blueprint" icon="wand-sparkles" href="/tickets/cab-to-ticket-conversion">
