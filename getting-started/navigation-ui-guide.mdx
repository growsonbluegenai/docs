...
Upon signing into Veylo you will land at your Projects Dashboard page.
...
**Shared with Me** shows projects which you have access to. This means that the project owner has added you via the [Collaboration Mode](/admin-platform/collaboration-features). Your access rights and permissions for each project may vary according to the owner's settings.
...
<Tip>
  > **The Veylo Platform currently supports 5 technology stacks:**
  >
  > **Web** - Web Application
  >
