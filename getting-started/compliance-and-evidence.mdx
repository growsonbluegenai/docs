...
description: "What the platform records as you build: the chain from source material to tested application, how chasaanges are attributed and reviewed, and the boundaries each agent works inside."
icon: "shield-check"
---
