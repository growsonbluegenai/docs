...
description: "BlueGenAI is an AI-enabled platform that augments the full Software Delivery Lifecycle (SDLC) to take a project from source requirements through to a deployed application, keeping the work traceable at every step."
icon: "circle-info"
---
