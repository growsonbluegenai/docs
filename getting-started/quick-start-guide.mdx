...
How a project moves from source material to a running application, and what each stage hands to the next.

<Note>
  **Before you start:** you need an account and something to build from — a requirements document, a solicitation, or an existing codebase. Anything the platform can read is enough to begin.
</Note>
