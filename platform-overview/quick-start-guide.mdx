...
![Web App from an Idea — Natural Language flows through Design, Build, and Deploy to Custom Web](/images/1-11-path-idea.png)
...
![Web App from a Solicitation — Contractual Reqs flows through Design, Build, and Deploy to Custom Web and Contractual Docs](/images/1-11-path-solicitation.png)
...
![Modernize a Legacy System — Legacy Apps flows through CAB, Design, Build, and Deploy to Custom Web](/images/1-11-path-legacy.png)
...
![Deploy to a Low-Code Platform — Requirements flow through Design, Build, and Deploy to Low Code Apps](/images/1-11-path-lowcode.png)
