...
![The CAB tab showing the upload panel on the left and the blueprint preview panel on the right](/images/1-8-cab-tab.png)
...
![The Tickets tab showing the Views panel on the left and the ticket list with filters on the right](/images/1-8-tickets-tab.png)
...
![The Prototype tab showing Requirement Folders on the left and the chat workspace on the right](/images/1-8-prototype-tab.png)
