...
<CardGroup cols={2}>
  ...
  <Card title="Three output types" icon="layer-group">
    Generate custom full-stack web applications, platform-native low-code configurations for Tyler Application Platform (TAP), ServiceNow, Salesforce, or PowerApps, or hybrid solutions combining both. The right output type depends on your agency's environment.
  </Card>
</CardGroup>
