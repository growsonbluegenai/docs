...
<CardGroup cols={2}>
  <Card title="Design Mode" icon="pencil">
    Where you describe what you want to build. Write prompts, upload reference materials, and work with the AI agent to produce mockups, requirements documents, and UI prototypes. Everything created in Design Mode is saved as a file you can reference when building.
  </Card>
...
<Steps>
  ...
  <Step title="Design your application">
    Use Design Mode to write prompts, upload reference files, and iterate on your application's structure and UI. Organize your work into Requirement Folders.
  </Step>
