...
description: "Where each role on a delivery team starts, what they do on a Veylo project, and which pages they need."
icon: "user-cog"
---

A delivery team brings several roles to a Veylo project, and each one enters the platform at a different point.
...
<Note>
  Every account on a customer team holds the platform role **User**. There is a separate administrator role, but it is held by Veylo staff and operates across the whole platform rather than within one organisation. It is not something a customer can hold or grant.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Project leadership" icon="layers" href="/tickets/epics">
  ...
  <Card title="AI Platform Engineers" icon="wand-sparkles" href="/tips-and-tricks/prompting-best-practices">
...
For why the platform rewards this shape of person, see [What is Veylo?](/).
