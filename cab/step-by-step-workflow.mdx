---
title: "Generating your first CAB"
...
<Steps>
  ...
  <Step title="Choose which sections to generate">
    ...
    **It is recommended to leave all sections checked each time**
    ...
    <Frame>
      ![Context Cab Config Generation Controls](/images/context-cab-config-generation-controls.png "Context Cab Config Generation Controls")
    </Frame>
  </Step>
...
<CardGroup cols={2}>
  <Card title="Understand what your blueprint contains" icon="file-text" href="/cab/blueprint-output-reference">
