...
<Frame caption="The review screen, part by part. It shows one change at a time.">
  ![The review surface with seven numbered callouts: the Save All and Discard All buttons that apply or drop everything at once, the AI Review chip marking this as a review pass, a count of your own edits in the pass, the change-type label showing where the change came from, the pager for moving between changes, the WAS and NOW rows holding the current and proposed values, and the Accept and Discard controls for the single change on screen.](/images/cab/editing-your-cab-review.png)
</Frame>
...
<Frame caption="The same toolbar before and after a single decision. Deciding anything relabels the buttons and adds a tally.">
  ![Two views of the review surface, one above the other. Before any decision the toolbar reads Save All and Discard All and there is no tally beside the pager. After accepting one change the buttons read Save and Discard, and a green tally showing one accepted change appears next to the pager.](/images/cab/editing-your-cab-decisions.png)
</Frame>
