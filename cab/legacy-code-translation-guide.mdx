...
<CardGroup cols={2}>
  <Card title="Find what your source material left undecided" icon="circle-question-mark" href="/cab/requirement-clarification">
    How the blueprint surfaces gaps and turns them into questions for stakeholders.
  </Card>

  <Card title="Check what came out of your codebase" icon="file-text" href="/cab/blueprint-output-reference">
