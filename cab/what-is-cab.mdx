...
<CardGroup cols={2}>
  ...
  <Card title="Check what you can upload" icon="file-up" href="/cab/supported-input-types">
    Accepted file types and how each is handled.
  </Card>

  <Card title="Read what came back" icon="file-text" href="/cab/blueprint-output-reference">
  ...
  <Card title="Find what your requirements left open" icon="circle-question-mark" href="/cab/requirement-clarification">
