...
Ask is a read-only mode for understanding your project, where the agent answers questions and cannot change anything.

## What You'll Learn

What Ask can do, what it is prevented from doing, and when to use it instead of Build.
