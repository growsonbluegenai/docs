...
<CardGroup cols={2}>
  <Card title="Ask about the code instead of reading it" icon="search" href="/web-apps/ask-mode">
    A read-only mode that traces behaviour and cites its evidence.
  </Card>

  <Card title="Push the code to a repository" icon="git-branch" href="/web-apps/git-integration">
