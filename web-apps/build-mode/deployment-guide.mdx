...
A project can be given a custom domain in place of the generated address. Your chosen name becomes a subdomain of `veyloapp.ai`.
...
<CardGroup cols={2}>
  ...
  <Card title="Test it automatically" icon="test-tube" href="/web-apps/app-testing">
