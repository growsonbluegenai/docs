...
The Codebase panel footer carries three Git controls: **Checkout**, **Pull**, and **Push**.

## What you'll learn

What each control does, what blocks them, and what version control is not available here.
