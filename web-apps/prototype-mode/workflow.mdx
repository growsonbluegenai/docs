...
<CardGroup cols={2}>
  <Card title="Carry a prototype into a build" icon="arrow-right-left" href="/web-apps/prototype-mode/output-handoff">
    What moves between modes, and what you have to take with you.
  </Card>

  <Card title="See what Prototype Mode covers" icon="wand-sparkles" href="/web-apps/prototype-mode/overview">
