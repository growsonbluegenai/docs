...
Working in Prototype Mode means organising your requirements into folders, prompting the agent in one of them, and saving what you want to keep.

## What You'll Learn

How the workspace is laid out, what each panel does, and how to set the look of everything the agent produces.

## The Workspace

Three columns. **Requirement Folders** on the left, the conversation in the middle, and any panel you open on the right.
