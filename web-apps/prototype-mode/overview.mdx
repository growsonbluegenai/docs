---
title: "Overview"
description: "Prototype Mode mocks up an html-based working front end from prompts, with no backend, so you can see and share an application before committing to build it."
icon: "code"
---
...
<CardGroup cols={2}>
  <Card title="Work in Prototype Mode" icon="ruler" href="/web-apps/prototype-mode/workflow">
